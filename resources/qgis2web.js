...
map.getView().fit([-5012640.167098, -2306036.047833, -4898918.428739, -2149014.110397], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Comunidades da Região 3 - NACAB</h2>';
        return titleElement;
    })(),
